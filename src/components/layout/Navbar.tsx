...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 w-full z-40 px-8 md:px-16 py-6 transition-all duration-300 ${
        isScrolled
    ...
    >
      <div className="w-full max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="flex items-center gap-3 font-sans text-[13px] text-muted">
          <a href="#work" className="link-underline hover:text-fg transition-colors">
            Work
          </a>
          <span className="text-muted/40">·</span>
          <a href="#about" className="link-underline hover:text-fg transition-colors">
            About
          </a>
          <span className="text-muted/40">·</span>
